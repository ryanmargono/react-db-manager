...
- Navigation: as a user I...
  ...
  DONE * can navigate to view a **Single Student** from **Single Campus** (for any student at that campus)
...
- Actions: as a user I...
  DONE * can create a campus
  DONE * can edit a campus's info, including adding/removing a student to/from that campus
